 ...
 */
class Quartiers extends \Ecommerce\EcommerceBundle\Entity\Quartiers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Quartiers' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Quartiers' . "\0" . 'nom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Quartiers' . "\0" . 'abrege', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Quartiers' . "\0" . 'arrondissement'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Quartiers $proxy) {
