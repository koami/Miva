 ...
 */
class Garanties extends \Ecommerce\EcommerceBundle\Entity\Garanties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Garanties' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Garanties' . "\0" . 'partenaire', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Garanties' . "\0" . 'produits', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Garanties' . "\0" . 'nom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Garanties' . "\0" . 'valeur', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Garanties' . "\0" . 'periode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Garanties $proxy) {
