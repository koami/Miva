...
class Categories extends \Ecommerce\EcommerceBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Categories' . "\0" . 'rayon', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Categories' . "\0" . 'image', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Categories' . "\0" . 'nom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Categories' . "\0" . 'subCategories'];
        }
    ...
    public function addSubCategory(\Ecommerce\EcommerceBundle\Entity\SubCategories $subCategories)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSubCategory', [$subCategories]);
    ...
    public function removeSubCategory(\Ecommerce\EcommerceBundle\Entity\SubCategories $subCategories)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSubCategory', [$subCategories]);
