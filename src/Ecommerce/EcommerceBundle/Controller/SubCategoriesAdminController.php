...
use Ecommerce\EcommerceBundle\Form\SubCategoriesType;
...
class SubCategoriesAdminController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_subCategories_show', array('id' => $entity->getId())));
        }

        return $this->render('EcommerceBundle:Administration:SubCategories\layout\new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcommerceBundle:Administration:SubCategories\layout\edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_subCategories_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_subCategories'));
    }
